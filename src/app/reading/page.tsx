            ...
            <div className="grid md:grid-cols-3 gap-4">
              {current.map((item, i) => (
                <div key={i} className="border border-stone-200 p-5">
                  ...
                  {item.note && (
                    <p className="text-xs text-stone-500 mt-3 leading-relaxed">{item.note}</p>
                  )}
                </div>
              ))}
            </div>
            ...
            <div key={category}>
              ...
              <div className="space-y-px">
                {items.map((item, i) => (
                  <div
                    key={i}
                    className="flex flex-col md:flex-row md:items-start gap-3 py-4 border-b border-stone-200"
                  >
