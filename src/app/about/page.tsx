        ...
        <div className="grid md:grid-cols-3 gap-16">
          <div className="md:col-span-2 space-y-10">
            ...
            <div>
              ...
              <h2 className="text-base font-medium text-stone-800 mb-3">Philosophy</h2>
              ...
              <h2 className="text-base font-medium text-stone-800 mb-3">Politics</h2>
              <p className="text-stone-600 leading-relaxed mb-6">
              ...
              <h2 className="text-base font-medium text-stone-800 mb-3">Economics</h2>
              <p className="text-stone-600 leading-relaxed">
            ...
            <div className="border border-stone-200 p-6">
              ...
              <dl className="space-y-2 text-sm">
                <div>
                  ...
                  <dd className="text-stone-600">University of Southampton</dd>
                </div>
                <div>
                  <dt className="text-stone-400">Degree</dt>
                  <dd className="text-stone-600">PPE (Philosophy, Politics & Economics)</dd>
                </div>
                <div>
                  <dt className="text-stone-400">Location</dt>
                  <dd className="text-stone-600">Southampton, UK</dd>
                </div>
                <div>
                  <dt className="text-stone-400">GitHub</dt>
                  <dd className="text-stone-600">mrailouis</dd>
                </div>
              </dl>
            </div>
          </div>
